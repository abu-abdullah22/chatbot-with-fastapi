...
const App = () => {
  ...
  return (
    <div className="bg-zinc-950 fixed inset-0 flex justify-center items-center p-4">
      ...
      <div className="w-full max-w-3xl bg-zinc-900 rounded-lg shadow-lg p-4 sm:p-6">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-xl text-white sm:text-2xl font-semibold">First AI Chatbot</h1>
        </div>
